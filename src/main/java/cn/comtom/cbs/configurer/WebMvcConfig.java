...
import cn.comtom.cbs.core.ResultCode;
import cn.comtom.cbs.core.ServiceException;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    private final static String DEVELOPMENT_ENV_NAME = "dev";
    private final static String ALIYUN_ENV_NAME = "aliyun";
    private final static String IP_UNKNOWN = "unknown";
    private final static String MULTIPLE_IP_DELIMITER = ",";
    ...
    public void addInterceptors(InterceptorRegistry registry) {
    	...
    	logger.info("------------->>>>"+env);
    	//if(true) return;
//        if (!DEVELOPMENT_ENV_NAME.equals(env) && !ALIYUN_ENV_NAME.equals(env)){
//
...
//        }
    ...
    private String getIpAddress(HttpServletRequest request) {
        ...
        if (ip != null && ip.indexOf(MULTIPLE_IP_DELIMITER) != -1) {
            ip = ip.substring(0, ip.indexOf(MULTIPLE_IP_DELIMITER)).trim();
        }
